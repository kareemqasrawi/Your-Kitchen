package com.kareem.yourkitchen.provider.auth
...
@Composable
fun VerificationCodeProvider(navController: NavController , yourInfoProviderViewModel: YourInfoProviderViewModel = viewModel()) {
    ...
    Column(
        ...
        Button(
            ...
            onClick = {
                ...
                yourInfoProviderViewModel.authProvider(enteredOTP.toInt(), context){
                    if (it)
